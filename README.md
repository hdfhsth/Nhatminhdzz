...
> **The author is not responsible for any misuse or illegal 
---
...
**PNM-DDoS** is a Distributed Denial of Service (DDoS) tool, written in Python, to help understand the mechanics of network stress testing and security evaluation.  
...
### Termux
***If you run the 2th time then
run: ```rm -rf Nhatminhdzz``` before
```sh
...
>
> PNM-DDoS is designed for security researchers, network administrators, and students to understand DDoS methodologies in a safe, controlled environment.
>
